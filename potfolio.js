...
arr.forEach((element, index) => {
  element.addEventListener("click", () => {
    element.classList.add("active_arr");
    if (left_container[index].classList.contains("off")) {
      left_container[index].classList.remove("off");
      left_container[index].classList.add("active1");
    }
  });
});

clc.forEach((element, index) => {
  element.addEventListener("click", () => {
    arr[index].classList.remove("active_arr");
    if (left_container[index].classList.contains("active1")) {
      left_container[index].classList.remove("active1");
      left_container[index].classList.add("off");
    }
  });
});
